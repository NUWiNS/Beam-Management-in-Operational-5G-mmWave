...
def reorganize_data_drive(data):
    ...
    # Process s21 data - DL data only
    s21_dl.extend(data['s21']['Downlink']['Drive'])

    # Process s24 data - DL data only
...
def data_to_box(s21_walk, s21_drive, s24_walk, s24_drive, save_flag, show_flag):
    ...
    # Print statistics
    print(f'MCS Statistics (Downlink):')
    ...
    # Save figure
    if save_flag:
        plt.savefig(f'D:/git/plots/box_s21_s24_mcs_dl.pdf',
...
# Main program
loaded_walk_data = load_data_from_pickle('D:/git/pkl/s21_s24_walk_mcs.pkl')
loaded_drive_data = load_data_from_pickle('D:/git/pkl/s21_s24_drive_mcs.pkl')
